...
public class ListUtil {
	 ...
	 * @return
	 */
	public static List<String> fromLongToStringList(List<Long> inList) {
		List<String> lList = new ArrayList<String>(inList.size());
		CollectionUtils.collect(inList, new Transformer() {
			public java.lang.Object transform(java.lang.Object input) {
	...
	public static void main(String[] args) {
		List<Long> inList = new ArrayList<Long>(2);
		inList.add(1L);
		inList.add(2L);
		List<String> strList = fromLongToStringList(inList);
