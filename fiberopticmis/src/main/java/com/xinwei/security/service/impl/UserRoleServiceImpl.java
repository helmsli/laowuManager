...
public class UserRoleServiceImpl  implements UserRoleService {
	...
	public void deleteByUserId(Long userId) {
		...
		//删除Activiti中用户、组关系
		syncUserAndGroupServiceImpl.deleteMembershipByUId(userId.toString());
	}
	...
	public void updateUserRole(List<UserRole> userRoles, Long userId) {
		...
		for (UserRole userRole : userRoles) {
			...
			//保存新的用户组关系到Activiti中
			syncUserAndGroupServiceImpl.saveMembership(userId.toString(), userRole.getRole_id().toString());
		}
	...
	public void save(UserRole userRole) {
		userRoleDao.save(userRole);
		//保存新的用户组关系到Activiti中
		syncUserAndGroupServiceImpl.saveMembership(
	...
	public void deleteUserRole(List<UserRole> userRoles) {
		for (UserRole userRole : userRoles) {
			...
			//删除Activiti中用户、组关系
			syncUserAndGroupServiceImpl.deleteMembership(
					userRole.getUser_id().toString(), 
					userRole.getRole_id().toString());
		}
