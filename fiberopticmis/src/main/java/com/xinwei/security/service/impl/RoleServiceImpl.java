...
public class RoleServiceImpl  implements RoleService {
	...
	public void update(Role role) {
		...
		roleDao.update(role);
		//在Activiti中修改相应的组信息	
		syncUserAndGroupServiceImpl.updateGroup(role.getId().toString(), 
	...
	public void delete(Long id) {
		...
		syncUserAndGroupServiceImpl.deleteMembershipByGroupId(id.toString());
		//删除对应Activiti中的用户组
		syncUserAndGroupServiceImpl.deleteGroup(id.toString());
	}
	...
	public void save(Role entity) {
		...
		roleDao.save(entity);
		//在Activiti中创建相应的组
		syncUserAndGroupServiceImpl.saveGroup(entity.getId().toString(), 
