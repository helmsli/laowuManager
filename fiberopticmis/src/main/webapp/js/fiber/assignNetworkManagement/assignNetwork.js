...
//	$scope.dataList = data.dataList;
	...
	{
		var parentScope=getAngularScope("projectManagerModel")||getAngularScope("projectModel");
		...
		for(var i =0; i<checkedList.length ;i++)
		{
			...
			//发送送给后台的指定三级部门经理
				...
				parentScope.extensionReview.netWorkId=checkedList[i].id;
				parentScope.extensionReview.netWorkPerson=parentScope.project.assignPersonText;
				//parentScope.basicInformation.representative=parentScope.project.assignPersonText;
				console.log("!!!!!!!!!!!!!!");
				console.log(parentScope.basicInformation);
		}
	}
