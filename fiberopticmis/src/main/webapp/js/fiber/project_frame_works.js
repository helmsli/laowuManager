...
function setUIData(data)
{
	...
	scope.examineInfo=examineInfo;
	//客户基本信息
	var customerBasicInformation=data.customerBasicInformation;
	scope.customerBasicInformation=customerBasicInformation;
	//工单信息
	var workOrderInformation=data.workOrderInformation;
	scope.workOrderInformation=workOrderInformation;
	//变更信息
	var changeInformation=data.changeInformation;
	scope.changeInformation=changeInformation;
	//财务审核信息
	var financialApproveInformation=data.financialApproveInformation;
	scope.financialApproveInformation=financialApproveInformation;
	//网管审核信息
	var networkApproveInformation=data.networkApproveInformation;
	scope.networkApproveInformation=networkApproveInformation;
	}
