/*定义module*/
var getUid="http://172.18.10.9:8088/fiber_center/customer/queryUid.do";
var getExtension="http://172.18.10.9:8088/fiber_center/fiberDelay/queryDelayInfo.do";
var getProductList="http://172.18.10.9:8088/fiber_center/product/queryProductList.do";
var getBalance="http://172.18.10.9:8088/fiber_center/customer/queryBalance.do";
var getFormNumIpURL="http://172.18.3.252:88/rolems/commonBiz/generateGroupId";
var from="";
...
App.config(function($translateProvider){
    ...
    var subLang = lang.substring(0,2); 
    if(subLang=='es'){
    	lang = 'es-ni';
    }else if(subLang=='zh'){
    	lang = 'zh-CN';
...
App.factory('translateTip', function($translate) {
    var translateTip = {};
    translateTip.context=function(key) {
        if(key){
...
function requestAjaxNative(options)
{
    var url=options.url;
    var ajaxData=options.data||"";
    var callBack=options.callBack;
